...
var SideTocPane = /** @class */ (function (_super) {
    ...
    function SideTocPane() {
        ...
        _this.handleCursorActivity = function (cm) {
            ...
            if (cur.line == _this.paneState.lastLine) {
                return;
            }
        ...
        _this.handleJumpToPrev = function () {
            ...
            if (_this.paneState.isPreview) {
                for (var i = 1; i < _this.paneState.previewHeaders.length; i++) {
                    ...
                    if (top_1 > 0) {
                        _this.paneState.previewHeaders[i - 1].scrollIntoView();
                        return;
                    }
                }
                (_a = _this.paneState.previewHeaders[_this.paneState.previewHeaders.length - 1]) === null || _a === void 0 ? void 0 : _a.scrollIntoView();
                return;
            }
            // for editor mode
            ...
            if (_this.paneState.isPreview) {
                for (var i = 0; i < _this.state.headers.length; i++) {
                    if (_this.state.headers[i] == header) {
                        _this.paneState.previewHeaders[i].scrollIntoView();
    ...
    SideTocPane.prototype.componentDidUpdate = function () {
        ...
        (_a = this.paneState.curSectionRef.current) === null || _a === void 0 ? void 0 : _a.scrollIntoView();
    };
    /*
     *
     */
    ...
    SideTocPane.prototype.createContent = function () {
        ...
        var statusBar = document.querySelector(".editor-status-bar-layout");
        var style = {
