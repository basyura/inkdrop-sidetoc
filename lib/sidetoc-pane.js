...
var SideTocPane = /** @class */ (function (_super) {
    ...
    function SideTocPane() {
        ...
        _this.previewCurrent = "";
        _this.cursorTime = null;
        _this.observer = null;
        /*
         *
         */
        ...
        _this.handleCmUpdate = function () {
            if (_this.props.editingNote._id != _this.noteId) {
                _this.noteId = _this.props.editingNote._id;
                _this.updateState();
                return;
            }
            var editor = inkdrop.getActiveEditor();
        ...
        _this.handleCursorActivity = function (cm) {
            ...
            if (cur.line == _this.lastLine) {
                return;
            }
            _this.lastLine = cur.line;
            _this.updateSection(cur.line);
            _this.cursorTime = new Date();
        };
        /*
        ...
        _this.handleCmScroll = function (cm) {
            ...
            if (_this.cursorTime != null &&
                new Date().getTime() - _this.cursorTime.getTime() < 100) {
                return;
            }
        ...
        _this.handleJumpToPrev = function () {
            // for preview mode
            if (_this.isPreview) {
                for (var i = 1; i < _this.previewHeaders.length; i++) {
                    var header_1 = _this.previewHeaders[i];
                    var top_1 = header_1.getBoundingClientRect().top;
                    if (top_1 > 0) {
                        _this.previewHeaders[i - 1].scrollIntoView();
                        return;
                    }
                }
                _this.previewHeaders[_this.previewHeaders.length - 1].scrollIntoView();
                return;
            }
            // for editor mode
        ...
        _this.handleJumpToNext = function () {
            // for preview mode
            if (_this.isPreview) {
                for (var i = _this.previewHeaders.length - 2; i >= 0; i--) {
                    var header_2 = _this.previewHeaders[i];
        ...
        _this.handlePreviewUpdate = function (editorEle) {
            _this.isPreview = editorEle.classList.contains("editor-viewmode-preview");
            // skip editor mode
            if (!_this.isPreview) {
                return;
            }
            _this.previewHeaders = [];
        ...
        _this.handlePreviewScroll = function (_) {
            ...
            // for first preview
            if (_this.previewHeaders == null) {
                _this.handlePreviewUpdate($(".editor"));
            }
            // analyze current header
            for (var i = _this.previewHeaders.length - 1; i >= 0; i--) {
                var top_3 = _this.previewHeaders[i].getBoundingClientRect().top;
                // create current header key
                if (top_3 < 100) {
                    var current = "";
                    var k = 0;
                    for (k = 0; k <= i; k++) {
                        current += "_" + _this.previewHeaders[k].innerText;
                    }
                    // change preview current
                    if (_this.previewCurrent != current) {
                        _this.previewCurrent = current;
            ...
            if (_this.isPreview) {
                for (var i = 0; i < _this.state.headers.length; i++) {
                    if (_this.state.headers[i] == header) {
                        _this.previewHeaders[i].scrollIntoView();
    ...
    SideTocPane.prototype.render = function () {
        ...
        return (React.createElement("div", { className: className, style: style }, this.state.headers.map(function (v) {
            ...
            var ref = isCurrent ? _this.curSectionRef : null;
    ...
    SideTocPane.prototype.attatchEvents = function (editor) {
        ...
        this.observer = new MutationObserver(function (_) {
